...
2. HANDOFF-MASTER.md で全体像把握
3. HANDOFF-module-10-stories.md で詳細仕様確認
4. 既存モジュール（例: module-09-operation-flow.md）でスタイル確認
5. ユーザーに「7. ユーザー確認事項」の質問を投げる
6. module-10-instagram-stories.md を作成開始
7. 完了したらこのファイルのチェックリストを更新
```
