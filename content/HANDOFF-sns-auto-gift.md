...
| 禁止 | 理由 |
|------|------|
| 他ツールを不当に批判 | 「論外」「嘘つき」などは事実と異なる場合がある |
| 古い情報での批判 | 最新バージョンでは改善されている可能性 |
| 「本当に」「絶対」 | 曖昧・誇大表現は避ける |
| ハッシュタグ大量使用 | 3つまでに絞る |
...
|------|----------|
| 1位の説明 | 「困ったらこれ」を明確に |
| 番外（論外）の扱い | 批判ではなく「使い分け」の観点で説明 |
| 各ツールの差別化 | 「こんな人におすすめ」「活用シーン」で具体化 |
| 比較 | 事実ベース（価格、機能）で比較。主観的批判は避ける |
...
`content/guides/scripts-ranking-videos.md` の台本1（AIツールランキング）用キャプション：

- トリガーワード: 好きな季節
- 特典URL: `/gift/genspark-guide`
- ハッシュタグ: `#AIツール #仕事効率化 #Genspark`
