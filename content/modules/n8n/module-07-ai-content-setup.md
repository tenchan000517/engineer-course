...
- [セクション1: システム全体像の理解](#セクション1-システム全体像の理解)
- [セクション2: 管理用シートの作成](#セクション2-管理用シートの作成)
- [セクション3: JSON→ideas変換GASの作成](#セクション3-jsonideas変換gasの作成)
- [セクション4: Gemini APIキーの取得](#セクション4-gemini-apiキーの取得)
- [セクション5: n8nでGemini Credentialを設定](#セクション5-n8nでgemini-credentialを設定)
- [セクション6: n8nワークフローの作成](#セクション6-n8nワークフローの作成)
- [セクション7: AIリサーチプロンプト](#セクション7-aiリサーチプロンプト)
