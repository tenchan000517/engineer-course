...
- [セクション1: Google Antigravityとは？](#セクション1-google-antigravityとは)
- [セクション2: ダウンロードとインストール](#セクション2-ダウンロードとインストール)
- [セクション3: 初期セットアップ](#セクション3-初期セットアップ)
- [セクション4: メイン画面の確認](#セクション4-メイン画面の確認)
