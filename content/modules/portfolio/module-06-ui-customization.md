...
- [ ] デザインシステムの4つの柱を理解しましたか？
- [ ] モノトーン戦略のメリットが分かりましたか？
- [ ] 自分のサイトに一貫性があるか確認しましたか？

---

## セクション2: カラースキーム変更（15分）
...
- [ ] 参考サイトを3つ以上見つけましたか？
- [ ] 開発者ツールで色やフォントを確認できましたか？
- [ ] デザインを言葉で説明できますか？

---

## 💬 セクション4: プロンプトエンジニアリング（25分）
...
- [ ] コンポーネントの概念を理解しましたか？
- [ ] コンポーネント化のメリットが分かりますか？
- [ ] Claude Codeにコンポーネント化を依頼できますか？
