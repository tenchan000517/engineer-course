...
| ファイル | 内容 |
|----------|------|
| `instagram-automation-guide.md` | フック→台本→動画生成の自動化完全ガイド |

### プロンプト・テンプレート

| ファイル | 内容 |
|----------|------|
| `instagram-master-prompt-harm.md` | HARM法則対応マスタープロンプト（投稿一括作成用） |
| `instagram-batch-content-harm-example.md` | 投稿一括作成の実例（リール5本+特典1本） |
