...
export async function generateStaticParams() {
  ...
  // instagram-dm-automation のモジュール
  const dmAutomationModules = getModulesByCategory('instagram-dm-automation');
...
export default async function SubcourseModulePage({
  ...
  const basePath = `/category/instagram/${subcourseSlug}`;
    ...
    <div className="flex min-h-screen bg-gray-50 overflow-x-hidden w-full">
      ...
      <aside className="hidden md:block fixed left-0 top-0 h-screen w-64 bg-white shadow-lg overflow-y-auto z-40">
        <div className="p-4 border-b">
          <Link href="/category/instagram" className="text-sm text-gray-500 hover:text-gray-700 flex items-center gap-1 mb-2">
