    ...
    <div className="min-h-screen bg-gray-50 overflow-x-hidden">
      <div className="max-w-6xl mx-auto px-4 md:px-8 py-8 md:py-16 w-full">
        ...
        <div className="flex items-center gap-2 text-gray-600 mb-8 text-sm">
          ...
          <Link href="/category/google-flow" className="hover:text-gray-900">
        ...
        <div className="mb-12 md:mb-16">
          ...
          <div className="space-y-3 md:space-y-4">
            {modules.map((module) => (
              <Link
                key={module.slug}
                href={`/category/google-flow/${subcourseSlug}/${module.slug}`}
        ...
        {modules.length > 0 && (
          <div className="text-center pb-8">
            <Link
              href={`/category/google-flow/${subcourseSlug}/${modules[0].slug}`}
