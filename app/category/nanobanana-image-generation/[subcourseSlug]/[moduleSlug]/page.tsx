...
export async function generateStaticParams() {
  ...
  // nanobanana-beginner のモジュール
  const beginnerModules = getModulesByCategory('nanobanana-beginner');
...
export default async function SubcourseModulePage({
  ...
  const basePath = `/category/nanobanana-image-generation/${subcourseSlug}`;
    ...
    <div className="flex min-h-screen bg-gray-50 overflow-x-hidden w-full">
      ...
      <aside className="hidden md:block fixed left-0 top-0 h-screen w-64 bg-white shadow-lg overflow-y-auto z-40">
        <div className="p-4 border-b">
          <Link href="/category/nanobanana-image-generation" className="text-sm text-gray-500 hover:text-gray-700 flex items-center gap-1 mb-2">
          ...
          <div className="flex justify-between items-center mb-6 md:mb-8 gap-2 w-full min-w-0">
            {prevModule ? (
              <Link
                ...
                className="flex items-center gap-1 md:gap-2 text-amber-600 hover:text-amber-800 font-medium px-3 md:px-6 py-2 md:py-3 rounded-lg transition-colors text-sm md:text-base"
              >
                <svg
            ...
            {nextModule ? (
              <Link
                ...
                className="flex items-center gap-1 md:gap-2 bg-amber-500 hover:bg-amber-600 text-white font-medium px-3 md:px-6 py-2 md:py-3 rounded-lg transition-colors text-sm md:text-base"
              >
